...
/** Color Tab Control */
class Viral_Mag_Box_Shadow_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'box_shadow' => esc_attr__('Box Shadow', 'viral-mag'),
            'x' => esc_attr__('X', 'viral-mag'),
            'y' => esc_attr__('Y', 'viral-mag'),
            'blur' => esc_attr__('Blur', 'viral-mag'),
            'spread' => esc_attr__('Spread', 'viral-mag'),
            'inset' => esc_attr__('Inset', 'viral-mag'),
            'color' => esc_attr__('Color', 'viral-mag'),
        );
        if (false === $id) {
