...
/** Border Control */
class Viral_Mag_Border_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'border_width' => esc_attr__('Width', 'viral-mag'),
            'border_type' => esc_attr__('Border Type', 'viral-mag'),
            'color' => esc_attr__('Border Color', 'viral-mag'),
            'top' => esc_attr__('Top', 'viral-mag'),
            'right' => esc_attr__('Right', 'viral-mag'),
            'bottom' => esc_attr__('Bottom', 'viral-mag'),
            'left' => esc_attr__('Left', 'viral-mag')
        );
        if (false === $id) {
    ...
    function get_all_border_types() {
        return array(
            '' => esc_attr__('None', 'viral-mag'),
            'solid' => esc_attr__('Solid', 'viral-mag'),
            'double' => esc_attr__('Double', 'viral-mag'),
            'dotted' => esc_attr__('Dotted', 'viral-mag'),
            'dashed' => esc_attr__('Dashed', 'viral-mag'),
            'groove' => esc_attr__('Groove', 'viral-mag')
        );
    }
